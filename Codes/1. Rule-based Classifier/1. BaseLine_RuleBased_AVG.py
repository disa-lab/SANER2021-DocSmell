...
data['total_method_class_package_count'] = data.apply(lambda x: x['class_name_count'] + x['package_name_count'], axis=1)
...
len_threshold = data['doc_length'].mean()
edit_distance_threshold = data['edit_distance_between_methodname_and_doc'].mean()
readability_threshold = data['doc_readability'].mean()
method_class_package_name_threshold = data['package_name_count'].mean()
doc_url_count_threshold = data['doc_urls_count'].mean()
