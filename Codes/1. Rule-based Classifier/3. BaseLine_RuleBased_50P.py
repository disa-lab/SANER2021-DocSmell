...
labeled_data = pd.read_excel("labelled_dataset_full.xlsx", encoding='utf-8')

del labeled_data['Method Prototype']
del labeled_data['Documentation Text']
...
method_class_package_name_threshold = np.percentile(data['total_method_class_package_count'].tolist(), percentile_value)
